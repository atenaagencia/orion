    ...
    <h4 class="text-dark text-purple font-weight-bold">Informações do Vínculo</h4>
        <div class="col-md-12 border-top p-2 mb-3">
            <div class=""><span class="font-weight-bold text-dark">Setor:</span> {{$associado->vinculo->setor}}</div>
              <div class=""><span class="font-weight-bold text-dark">Supervisor</span> {{date('d/m/Y', strtotime($associado->vinculo->data_vinculo))}}</div>
            <div class=""><span class="font-weight-bold text-dark">Inicio do Vinculo:</span> {{$associado->vinculo->supervisor}}</div>
