...
$sup = $supervisores->where('supervisor','sim')->where('id','<>',$associado->id)->get()->pluck('nome', 'id');
   ...
   <div class="form-group row">
      ...
      <div class="col-sm-6">
         ...
         {!! Form::select('setor_id',$setor = Arr::prepend($setor, '----', ''), $value=null, ['class'=>
         ['form-control'],'required']) !!}

      </div>
      <div class="col-sm-6">
         {!! Form::label('cargo', 'Cargo:', ['']) !!}
         {!! Form::select('cargo_id', $cargo = Arr::prepend($cargo, '----', ''), $value=null, ['class'=>
         ['form-control'],'required']) !!}
      ...
      <div class="col-sm-6">
         ...
         {!! Form::select('tipo_vinculo', ['' => '---','associado' => 'Associado','estagiario'=>
         'Estágiario'],$value=null,
